...
func UserCreate(ctx context.Context, input model.NewUser) (*model.User, error) {
	...
	user := model.User{
		...
		Activated:         false,
		ProfilePictureURL: "https://firebasestorage.googleapis.com/v0/b/linkhedin-vt.appspot.com/o/profilePictures%2Fdefault.jpg?alt=media&token=10a15675-4c98-454a-8bdd-bc5914611547",
